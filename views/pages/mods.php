<?php
// views/pages/mods.php

// 1. Conexión para el menú lateral de categorías
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-4">
            <div class="card bg-transparent border border-secondary shadow-sm">
                <div class="card-body p-4">
                    <h4 class="text-danger fw-bold mb-4 border-bottom border-secondary pb-3 text-uppercase">CATEGORÍAS</h4>
                    
                    <ul class="list-unstyled mb-0">
                        <li class="mb-4">
                            <a href="index.php?pagina=mods" class="text-warning text-decoration-none fw-bold fs-5 d-flex align-items-center">
                                <i class="bi bi-arrow-right-short fs-3 me-2 text-warning"></i> Ver Todo
                            </a>
                        </li>
                        
                        <?php foreach ($lista_categorias as $cat): ?>
                        <li class="mb-4">
                            <a href="index.php?pagina=mods&categoria=<?php echo urlencode($cat['NOMBRE_CATEGORIA']); ?>" 
                               class="text-light text-decoration-none fs-5 hover-warning d-flex align-items-center">
                                <i class="bi bi-arrow-right-short fs-3 me-2 text-light"></i> 
        ...
        <div class="col-md-9">
            <?php if (!empty($categoria_seleccionada)): ?>
                <h2 class="mb-4 text-warning text-uppercase fw-bold">CATÁLOGO DE <?php echo htmlspecialchars($categoria_seleccionada); ?></h2>
            <?php else: ?>
                <h2 class="mb-4 text-warning text-uppercase fw-bold">CATÁLOGO DE SUMINISTROS</h2>
            <?php endif; ?>
            
            <div class="row">
                <?php if (empty($productos)): ?>
                    <div class="col-12"><div class="alert alert-danger bg-black border-danger text-light"><i class="bi bi-exclamation-circle me-2"></i> <?php echo htmlspecialchars($mensagem_catalogo); ?></div></div>
                <?php else: ?>
                        ...
                        <div class="card h-100 bg-dark border-secondary text-light shadow-sm">
                            ...
                            <div class="card-body d-flex flex-column p-4">
                                <div class="d-flex align-items-start mb-3">
                                    ...
                                    <div>
                                        <h5 class="card-title text-warning fw-bold mb-1 text-uppercase"><?php echo htmlspecialchars($producto['NOMBRE_PRODUCTO'] ?? 'Sin Nombre'); ?></h5>
                                ...
                                <div class="mt-auto">
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <a href="index.php?pagina=detalle&id=<?php echo $id_prod; ?>" class="btn btn-outline-warning text-uppercase">VER ESPECIFICACIONES</a>
                                        
                                        <?php if ($ya_lo_tiene): ?>
                                            <button class="btn btn-success fw-bold d-flex align-items-center justify-content-center disabled text-uppercase" style="opacity: 1; cursor: not-allowed;">
                                                <i class="bi bi-check-circle-fill me-2"></i> ADQUIRIDO
                                            </button>
                                        <?php else: ?>
                                            <a href="index.php?pagina=mods&add_prod=<?php echo $id_prod; ?>" class="btn btn-warning fw-bold d-flex align-items-center justify-content-center text-uppercase">
                                                <i class="bi bi-cart-plus-fill me-2"></i> ADQUIRIR
                                            </a>
                                        <?php endif; ?>
                                    </div>
                                </div>
